...
\textcolor{red}{For example, fields for a single-point computation are molecule, method, basis, program, and a unique keyword set identifier, which together describe a unique computation in the database.}
