...
\begin{itemize}
    ...
    \item \qcsk - A community built key-value/array description of QC (or QC-like) objects such as molecules and input/output quantities from QC programs. (This important component, which has been developed somewhat separately from the rest of the \qca package, will be decscribed in a later publication.) \url{https://github.com/MolSSI/QCSchema}
\end{itemize}
...
computation and data storage requirements for an individual researcher or groups of researchers concurrently. (See
the tutorial at \url{https://docs.qcarchive.molssi.org/projects/QCFractal/en/stable/quickstart.html} for an example of the \qcf ecosystem.)
